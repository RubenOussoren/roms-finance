class Assistant::Function::GetIncomeStatement < Assistant::Function
  ...
  def call(params = {})
    period = Period.custom(start_date: safe_parse_date(params["start_date"]), end_date: safe_parse_date(params["end_date"]))
...

    {
      ...
      insights: get_insights(statement, income_data, expense_data)
    }
  end
  ...
  private
    ...
    def get_insights(statement, income_data, expense_data)
