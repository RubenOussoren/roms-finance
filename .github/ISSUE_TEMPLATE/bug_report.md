...
about: Open a bug report when you experience broken functionality within the latest
  version of the ROMS Finance app
...
### How are you using ROMS Finance?

- [ ] I am a paying ROMS Finance customer (hosted version)
  - Paying ROMS Finance users can also open requests in Intercom (if there is sensitive info involved)
...
- Self hosted app commit SHA (find in user menu): [enter commit sha here]
  - [ ] I have confirmed that my app's commit is the latest version of ROMS Finance
...
Be as specific as possible so maintainers can quickly reproduce the bug you're experiencing.
