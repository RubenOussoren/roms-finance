...
A bug is _broken functionality_ of the app (i.e. it prevents you from using the app).  For bugs, please use the "Bug Report" template instead.

### Is this a bug with _sensitive info_?

If you are a _paying_ ROMS Finance user, you can open a support request in Intercom.

### Is this a feature request?

A feature request is functionality that you would like that is not already on our roadmap.

All feature requests should be opened in a Feature Request Discussion.
...
- **First**: Read our Docker hosting guide and follow it step-by-step
- Open a Docker Discussion
